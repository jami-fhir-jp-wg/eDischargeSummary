...
|入院詳細情報エントリ(退院時詳細情報、入院理由を含む)                    |Encounterリソース                                      |1..1            |
...
|4|文書法的責任者|attester(.mode=legal)||診療情報提供書認証者|―|
|5|文書作成機関|author|使用しない|紹介元責任者・同組織|Organization|
|6|文書管理責任機関|custodian|任意|文書管理責任組織|Organization|
...
|&emsp;├&emsp;322                                       |入院詳細セクション<br>admissionDetailsSection                 |必須                                 |入院時情報、入院時補足情報、入院時主訴・入院理由|Encounter本表の<br>他のEncounterと<br>同一インスタンスを参照。         |1..1 |
|&emsp;├&emsp;342                                       |入院時診断セクション<br>admissionDiagnosesSection             |必須                                 |入院時情報                                      |Condition                                                      |0..\*|
|&emsp;├&emsp;510                                       |アレルギー・不耐性反応セクション<br>allergiesIIntoleranceSection|必須                                 |アレルギー・不適応反応                          |AllergyIntolerance                                             |0..\*|
|&emsp;├&emsp;352                                       |入院時主訴セクション<br>chiefComplaintSection|必須                                 |主訴                                            |Condition                                                      |0..\*|
|&emsp;├&emsp;312                                       |入院理由セクション<br>reasonForAdmissionSection                 |必須                                 |入院理由                                        |Encounter本表の<br>他のEncounterと<br>同一インスタンスを参照。         |0..1 |
|&emsp;├&emsp;362                                       |入院時現病歴セクション<br>presentIllnessSection      |必須                                 |入院前経過.現病歴                               |Condition                                                      |0..\*|
|&emsp;├&emsp;372                                       |入院時既往歴セクション<br>pastIllnessOnAdmissionSection         |任意                                 |入院前経過.既往歴                               |Condition                                                      |0..\*|
|&emsp;├&emsp;432                                       |入院時服薬セクション<br>admissionMedicationsSection           |任意                                 |入院前経過.常用薬                               |MedicationStatement                                            |0..\*|
|&emsp;├&emsp;642                                       |入院時社会歴セクション<br>socialHistorySection       |任意                                 |入院前経過.社会歴                               |Observation                                                    |0..\*|
|&emsp;├&emsp;612                                       |入院時身体所見セクション<br>admissionPhysicalStatusSection    |任意                                 |入院前経過.身体所見                             |Observation                                                    |0..\*|
|&emsp;├&emsp;552                                       |入院時家族歴セクション<br>familiyHistorySection      |任意                                 |入院前経過.家族歴                               |FamilyMemberHistory                                            |0..\*|
|&emsp;├&emsp;333                                       |入院中経過セクション<br>hospitalCourseSection                   |必須                                 |入院経過                                        |ClinicalImpression                                             |1..\*|
|&emsp;├&emsp;324                                       |退院時詳細セクション<br>dischargeDetailsSection               |必須                                 |退院時の状態                                    |Encounter本表の<br>他のEncounterと<br>同一インスタンスを参照。         |1..1 |
|&emsp;├&emsp;344                                       |退院時診断セクション<br>dischargeDiagnosesSection             |必須                                 |退院時情報                                      |Condition                                                      |1..\*|
|&emsp;├&emsp;444                                       |退院時投薬指示セクション<br>dischargeMedicationSection        |必須                                 |退院時投薬指示                                  |MedicationRequest ｜Bundle(電子処方箋)                         |0..\*|
|&emsp;├&emsp;424                                       |退院時方針指示セクション<br>dischargeInstructionSection       |必須                                 |退院時方針                                      |CarePlan                                                       |0..\*|
|&emsp;├&emsp;614                                       |退院時身体所見セクション<br>dischargePhysicalStatusSection    |任意                                 |―                                              |Observation                                                    |0..\*|
|&emsp;├&emsp;713                                       |入院中治療セクション<br>hospitalProcedureSection                |任意                                 |手術・処置・治療                                |Procedure                                                      |0..\*|
|&emsp;├&emsp;623                                       |入院中検査結果セクション<br>hospitalStudySection                |任意                                 |（検体・画像・生理・病理）検査結果              |Observation \| <br>ImagingStudy \| <br>DiagnosticReport \| <br>Bundle <br>(報告書)|0..\*|
|&emsp;├&emsp;810                                       |医療機器セクション<br>medicalDeviceSection                      |任意                                 |医療機器                                        |DeviceUseStatement                                             |0..\*|
|&emsp;├&emsp;530                                       |予防接種歴セクション<br>immunizationSection                     |任意                                 |感染症・予防接種歴                              |Immunization                                                   |0..\*|
|&emsp;├&emsp;410                                       |事前指示セクション<br>advanceDirectiveSection                   |任意                                 |事前指示                                        |Consent                                                        |0..\*|
